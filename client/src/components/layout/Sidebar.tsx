...
const sections: { label: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: HeartPulse, label: "Consultation Episodes", href: "/transactions", page: "episodes" },
      { icon: Gift, label: "Referrals", href: "/referrals", page: "episodes" },
      { icon: CalendarClock, label: "Surgery Schedule", href: "/surgery-calendar", page: "episodes" },
