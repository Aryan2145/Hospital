...
export function Sidebar() {
  ...
  return (
    <div className="h-screen w-64 bg-white border-r border-border flex flex-col shadow-xl z-20">
      {/* Brand Header */}
      <div className="p-6 border-b border-border/50">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-xl tracking-tight text-primary">VIROC</h1>
