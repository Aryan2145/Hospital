...
const STATUS_COLORS: Record<string, string> = {
  ...
  "Pre-op Assessment": "bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-300",
  ...
  "Discharge / Billing Clearance": "bg-rose-100 text-rose-700 dark:bg-rose-900/30 dark:text-rose-300",
