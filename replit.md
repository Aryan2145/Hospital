...
- 2026-02-22: Full responsive design - AppLayout with hamburger menu on mobile, Sheet overlay sidebar; all 14 pages adapted for phone/tablet/desktop; Lead Detail stacks vertically on mobile; Kanban narrower columns on mobile; tables have horizontal scroll; buttons collapse to icon-only on mobile
