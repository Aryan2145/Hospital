...
export async function sendPasswordResetEmail(
  ...
  await transporter.sendMail({
    from: `"VIROC Hospital CRM" <${fromEmail}>`,
    to,
    subject: "Password Reset - VIROC Hospital CRM",
    html: `
      <div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 520px; margin: 0 auto; padding: 32px 24px; background: #fff;">
        <div style="text-align: center; margin-bottom: 28px;">
          <h2 style="color: #0f4c81; margin: 0; font-size: 22px;">VIROC Hospital CRM</h2>
        </div>
        ...
        <p style="font-size: 12px; color: #aaa; text-align: center;">VIROC Super Speciality Orthopaedic Hospital</p>
      </div>
    `,
  });
}
